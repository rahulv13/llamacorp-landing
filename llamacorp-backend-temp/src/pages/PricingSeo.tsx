...
const plans: PricingPlan[] = [
  {
    name: 'Foundation SEO',
    description: 'Essential optimization for local and small businesses.',
    monthlyPrice: '699',
    annualPrice: '599',
    features: ['Technical Audit', 'Keyword Research', 'On-page Optimization (up to 10 pages)', 'Basic Link Building'],
  },
  {
    name: 'Advanced SEO',
    description: 'Aggressive growth strategies for competitive markets.',
    monthlyPrice: '1499',
    annualPrice: '1299',
    isMostPopular: true,
    features: ['Comprehensive Technical SEO', 'Content Strategy & Creation', 'On-page Optimization (Unlimited)', 'High-Quality Backlinking', 'Monthly Strategy Meetings'],
  },
  {
    name: 'Enterprise SEO',
    description: 'Custom SEO solutions for large-scale operations.',
    monthlyPrice: 'Custom',
    annualPrice: 'Custom',
    isCustom: true,
    ctaText: 'Contact Sales',
    features: ['Global SEO Strategy', 'Programmatic SEO', 'In-depth Competitor Analysis', 'Dedicated SEO Team', 'Real-time Reporting Dashboard'],
  }
];
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] text-zinc-900 font-sans selection:bg-zinc-800 selection:text-white">
      ...
      <section className="pt-48 pb-20 px-6 max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        >
          Dominate search results and drive organic traffic with our proven SEO strategies.
        </motion.p>
