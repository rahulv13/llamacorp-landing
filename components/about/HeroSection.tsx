    ...
    <section className="w-full max-w-[1200px] mx-auto flex flex-col items-center text-center px-6 pb-12 pt-10">
      ...
      >
        <div className="flex items-center gap-2">
          <Image src="/logo2.svg" alt="Logo" width={16} height={16} className="w-4 h-4 grayscale opacity-60" />
          <span>LlamaCorp</span>
        </div>
      ...
      {/* Main Headline */}
      <FadeIn 
        duration={0.6} yOffset={20} delay={0.1}
        className="max-w-[800px] mx-auto mb-6"
      >
        <h1 className="text-[clamp(2.5rem,6vw,4.5rem)] leading-[1.05] tracking-[-0.04em] font-bold text-[#111111]">
      ...
      {/* Subheadline & Tag */}
      <FadeIn 
        duration={0.6} yOffset={20} delay={0.2}
