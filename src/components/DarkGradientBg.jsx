export function DarkGradientBg({ children, className = "" }) {
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 opacity-[0.03] bg-repeat pointer-events-none mix-blend-overlay"
        style={{
      ...
      <div 
        ...
        style={{ background: 'radial-gradient(circle at center, rgba(30,41,59,0.2) 0%, transparent 60%)' }}
      />
