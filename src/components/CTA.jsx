        ...
        <footer className="w-full border-t border-white/10 relative z-30 bg-black/20 backdrop-blur-md">
          <div className="w-full px-6 md:px-12 lg:px-24 py-8 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex flex-wrap justify-center items-center gap-4 md:gap-6 text-sm text-white/50 font-medium">
              <a href="https://github.com/rahulv13" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Work</a>
              <a href="https://github.com/rahulv13" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Services</a>
              <a href="https://github.com/rahulv13" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">FAQ</a>
              <a href="https://github.com/rahulv13" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Privacy</a>
              ...
              <div className="flex items-center justify-center gap-4 ml-0 md:ml-2 border-l-0 md:border-l border-white/10 pl-0 md:pl-6 w-full md:w-auto mt-2 md:mt-0">
                <a href="https://github.com/rahulv13" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="LinkedIn">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
                </a>
                <a href="https://github.com/rahulv13" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="Instagram">
