...
const OriginButton = React.forwardRef(
  (
    ...
    // Only do animation on hover as requested, ignoring isPressed.
    const showFill = !isDisabled && hovered;
    ...
    return (
      <MotionComponent
        ...
        className={cn(
          ...
          "relative inline-flex h-auto py-3.5 cursor-pointer touch-manipulation select-none items-center justify-center overflow-hidden rounded-2xl px-8 font-medium text-[15px] tracking-[-0.02em]",
        ...
        style={href ? { textDecoration: 'none', ...props.style } : props.style}
      >
        <motion.span
