            ...
            return (
              <div
                ...
                style={{
                  ...
                  // @ts-ignore - CSS variables are allowed but TS doesn't know
...
export function Footer() {
  ...
  return (
    <footer className="bg-[#0a0a0a] w-full pt-20 pb-8 px-6 text-white relative overflow-hidden min-h-[400px] flex flex-col justify-end mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-2 flex flex-col items-start">
            <Link href="/" className="flex items-center gap-3 mb-6">
              <Image src="/logo2.svg" alt="Llamacorp Logo" width={32} height={32} className="w-8 h-8 filter brightness-0 invert" />
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-sm text-white/60">
              ...
              <li><Link href="/work" className="hover:text-white transition-colors duration-300">Works</Link></li>
