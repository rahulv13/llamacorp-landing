...
export default function PageTransitionSystem({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    if (pathname !== renderedPath) {
      ...
      const prevIndex = routesOrder.indexOf(renderedPath);
      const currIndex = routesOrder.indexOf(pathname);
      ...
      const wipeTransition = async () => {
        ...
        let endClip = '';
        switch(dir) {
          case 'right': endClip = 'polygon(0% 0%, 0% 0%, 0% 100%, 0% 100%)'; break;
          case 'left': endClip = 'polygon(100% 0%, 100% 0%, 100% 100%, 100% 100%)'; break;
          case 'bottom': endClip = 'polygon(0% 0%, 100% 0%, 100% 0%, 0% 0%)'; break;
          case 'top': endClip = 'polygon(0% 100%, 100% 100%, 100% 100%, 0% 100%)'; break;
  ...
  }, [pathname, renderedPath, controls, shouldReduceMotion]);
