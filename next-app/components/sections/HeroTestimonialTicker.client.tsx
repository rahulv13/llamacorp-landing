...
export default function HeroTestimonialTicker() {
    ...
    <div className="relative h-10 md:h-12 flex justify-center items-center mb-7 md:mb-9 w-full max-w-full overflow-hidden md:overflow-visible" aria-live="polite">
      {testimonials.map((t, index) => {
        ...
        return (
          ...
          >
            <Image src={t.avatar} alt="" width={28} height={28} className="w-6 h-6 md:w-7 md:h-7 rounded-full object-cover shrink-0" />
