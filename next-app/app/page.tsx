...
import HeroTestimonialTicker from '@/components/sections/HeroTestimonialTicker.client';

export const metadata = constructMetadata({
  title: "AI Web Design & Development Agency | Llamacorp",
  ...
  return (
    <>
      <main id="hero" className="relative w-full max-w-[1200px] px-4 md:px-6 lg:px-8 mx-auto flex flex-col items-center text-center pt-[120px] md:pt-[160px] pb-8 md:pb-10 overflow-hidden md:overflow-visible box-border">
        ...
        {/* Isolated Client Animation */}
        <HeroTestimonialTicker />
        ...
        <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto mx-auto px-0">
          ...
          <Link href="/work" className="flex justify-center items-center bg-transparent text-[#111] border border-black/10 rounded-full no-underline text-[15px] font-medium transition-all hover:border-[#111] hover:bg-black/5 w-full max-w-[360px] md:w-auto mx-auto min-h-[52px] px-7">Our Work</Link>
        </div>
      </main>
